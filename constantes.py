...
PERSONAGEM_UP = carregar_imagem('./Imagens/jefer.png')
PERSONAGEM_UP = definir_dimensoes(PERSONAGEM_UP, LARGURA_PERSONAGEM, ALTURA_PERSONAGEM)

PERSONAGEM_DOWN = carregar_imagem('./Imagens/jefer.png')
...
LARGURA_INIMIGO = 50
ALTURA_INIMIGO = 55
INIMIGO = carregar_imagem('./Imagens/apple.png')
INIMIGO = definir_dimensoes(INIMIGO, LARGURA_INIMIGO, ALTURA_INIMIGO)
INIMIGO_RIGHT = INIMIGO
INIMIGO_LEFT = INIMIGO

#tiro
TIRO = carregar_imagem('./Imagens/xiaomi.png')
TIRO = definir_dimensoes(TIRO,10,10)
